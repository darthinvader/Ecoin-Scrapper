...
USDTPairs = ['BTC','ETH','NEO','BNB','LTC','BCC']

BTCPairs = ['ETH','ICX','IOST','TRX','XRP','ELF','NEO','WTC','BNB','CMT','VEN','EOS','VIB','MTH','HSR','XLM','LTC','ADA','CND','ETC','POE','GAS',
            'BRD','IOTA','LUN','BCC','LEND','OMG','QTUM','XVG','AION','BTS','DASH','PPT','GVT','ICN','RCN','VIBE','GTO','XMR','ZRX','ENJ','STRAT',
...
ETHPairs = ['TRX','ICX','XRP','NEO','EOS','VEN','WTC','IOST','ELF','CMT','XLM','VIB','ADA','MTH','BNB','LTC','CND','IOTA','OMG','BCC','POE','PPT',
...
BNBPairs = ['ICX','NEO','VEN','CMT','ADX','WTC','CND','XLM','LTC','IOTA','BCC','BTS','QSP','APPC','AION','AMB','NEBL','GTO','NULS','YOYO','POWR',
